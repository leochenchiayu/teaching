    ...
    <div class="full-width" id="bg">
        <div class="fixed-width clearfix loginmt">
            <div class="col-xl-20 col-20">
                <div class="loginform">
                    <form class="login">
                        <h1 align="center"><strong>會員註冊</strong> </h1>
                        <h1 align="center" class="loginen">register</h1>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="re_password" value="" placeholder="請輸入密碼">
                        </div>
        ...
        $(document).ready(function(){
            ...
            $("form.login").submit(function(){
                ...
                if($("#password").val() == "" || $("#account").val()==""){
                    ...
                    $.ajax({
                        type : "POST",
                        url : "../php/check_user.php", //因為此 login.php 是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 verify_user.php
                        data : {
                        ...
                        if(data == "yes"){
                            $.ajax({
                                type : "POST",
                                url : "../php/add_user.php", //因為此 login.php 是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 verify_user.php
                                data : {
                                    un : $("#account").val(), //使用者帳號
                                    pw : $("#password").val() //使用者密碼
                                },
